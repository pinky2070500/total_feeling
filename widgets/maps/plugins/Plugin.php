...
namespace app\widgets\maps\plugins;
...
abstract class Plugin extends Component
{
    ...
    public function getName($autoGenerate = false)
    {
        if ($autoGenerate && $this->_name === null) {
            $this->_name = LeafletMap::generateName();
        }
        return $this->_name;
    }
    ...
    {
        return empty($this->clientOptions) ? '{}' : Json::encode($this->clientOptions, LeafletMap::JSON_OPTIONS);
    }
