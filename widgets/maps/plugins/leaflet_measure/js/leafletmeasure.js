!function(e) {
    ...
    , function(e, t, r) {
        e.exports = '<a class="{{ model.className }}-toggle js-toggle" href=# title="Measure distances and areas">Measure</a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt"> <h3>Đo khoảng cách và diện tích</h3> <ul class=tasks> <a href=# class="js-start start">Bắt đầu đo</a> </ul> </div> <div class=js-measuringprompt> <h3>Đo khoảng cách và diện tích</h3> <p class=js-starthelp>Bằng đầu đo bằng cách chấm điểm trên bản đồ</p> <div class="js-results results"></div> <ul class="js-measuretasks tasks"> <li><a href=# class="js-cancel cancel">Hủy</a></li> <li><a href=# class="js-finish finish">Kết thúc đo</a></li> </ul> </div> </div> '
    }
    , function(e, t, r) {
        e.exports = '<div class=group> <p class="lastpoint heading">Điểm cuối </p> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> </div> <% if (model.pointCount > 1) { %> <div class=group> <p><span class=heading>Khoảng cách</span> {{ model.lengthDisplay }}</p> </div> <% } %> <% if (model.pointCount > 2) { %> <div class=group> <p><span class=heading>Diện tích</span> {{ model.areaDisplay }}</p> </div> <% } %> '
    }
    , function(e, t, r) {
        e.exports = '<h3>Điểm</h3> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Vị trí trung tâm</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Đóng</a></li> </ul> '
    }
    , function(e, t, r) {
        e.exports = '<h3>Kết quả đo</h3> <p>Khoảng cách: {{ model.lengthDisplay }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Trung điểm</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Đóng</a></li> </ul> '
    }
    , function(e, t, r) {
        e.exports = '<h3>Kết quả đo</h3> <p>Diện tích: {{ model.areaDisplay }}</p> <p>Chu vi: {{ model.lengthDisplay }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Trọng tâm</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Đóng</a></li> </ul> '
    }
]);
