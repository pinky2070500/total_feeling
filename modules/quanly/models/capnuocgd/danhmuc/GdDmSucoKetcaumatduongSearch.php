...
/**
 * GdDmSucoKetcaumatduongSearch represents the model behind the search form about `app\modules\quanly\models\capnuocgd\danhmuc\GdDmSucoKetcaumatduong`.
 */
class GdDmSucoKetcaumatduongSearch extends GdDmSucoKetcaumatduong
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = GdDmSucoKetcaumatduong::find()->where(['status'=>1]);
