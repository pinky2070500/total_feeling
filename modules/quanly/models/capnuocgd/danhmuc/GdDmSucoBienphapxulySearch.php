...
/**
 * GdDmSucoBienphapxulySearch represents the model behind the search form about `app\modules\quanly\models\capnuocgd\danhmuc\GdDmSucoBienphapxuly`.
 */
class GdDmSucoBienphapxulySearch extends GdDmSucoBienphapxuly
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = GdDmSucoBienphapxuly::find()->where(['status'=>1]);
