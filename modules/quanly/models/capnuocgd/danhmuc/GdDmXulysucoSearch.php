...
/**
 * GdDmXulysucoSearch represents the model behind the search form about `app\modules\quanly\models\capnuocgd\danhmuc\GdDmXulysuco`.
 */
class GdDmXulysucoSearch extends GdDmXulysuco
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = GdDmXulysuco::find()->where(['status'=>1]);
