...
/**
 * CayCaPheSearch represents the model behind the search form about `app\modules\quanly\models\caphe\CayCaPhe`.
 */
class CayCaPheSearch extends CayCaPhe
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['geom', 'layer', 'lat', 'long', 'created_at', 'updated_at'], 'safe'],
        ];
    }
    ...
    {
        $query = CayCaPhe::find()->where(['status' => 1]);
