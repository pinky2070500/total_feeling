...
/**
 * CaySuaDaTrongSearch represents the model behind the search form about `app\modules\quanly\models\caphe\CaySuaDaTrong`.
 */
class CaySuaDaTrongSearch extends CaySuaDaTrong
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = CaySuaDaTrong::find()->where(['status' => 1]);
