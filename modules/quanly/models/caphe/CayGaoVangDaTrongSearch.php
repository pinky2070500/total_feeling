...
/**
 * CayGaoVangDaTrongSearch represents the model behind the search form about `app\modules\quanly\models\caphe\CayGaoVangDaTrong`.
 */
class CayGaoVangDaTrongSearch extends CayGaoVangDaTrong
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = CayGaoVangDaTrong::find()->where(['status' => 1]);
