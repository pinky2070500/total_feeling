...
/**
 * SearchDonghoKh represents the model behind the search form about `app\modules\quanly\models\aphu\DonghoKh`.
 */
class SearchDonghoKh extends DonghoKh
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'objectid', 'codongho', 'hopbaove', 'created_by', 'updated_by', 'status'], 'integer'],
            [['geom', 'sothandong', 'loaidongho', 'hieudongho', 'dbdonghonu', 'vitrilapda', 'tinhtrang', 'sohopdong', 'masochi', 'sohoso', 'madma', 'malotrinh', 'tinhtrangq', 'ngaybamchi', 'ngaylapdat', 'sonha', 'tenduong', 'ghichu', 'maphuong', 'maquan', 'tenkhachha', 'dtdd', 'ddtb', 'email', 'code', 'code_fu', 'giabieu', 'dinhmuc', 'bithuy', 'ngaycapnha', 'kiemtra', 'globalid', 'diachi', 'created_at', 'updated_at', 'lat', 'long', 'geojson'], 'safe'],
            [['dosau', 'docao'], 'number'],
        ];
    }
    ...
    {
        $query = DonghoKh::find()->where(['status'=>1]);
        ...
        $query->andFilterWhere([
            ...
            'ngaybamchi' => $this->ngaybamchi,
            'ngaylapdat' => $this->ngaylapdat,
            'docao' => $this->docao,
            'ngaycapnha' => $this->ngaycapnha,
