...
/* @var $searchModel app\modules\quanly\models\capnuocgd\GdTramcuuhoaSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = (isset($const['title'])) ? $const['title'] : 'Trạm cứu hỏa';
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="gd-tramcuuhoa-index">
