...
<div class="gd-tramcuuhoa-form">
    ...
    <div class="block block-themed">
        ...
        <div class="block-content">
            ...
            <div class="row">
                <div class="col-lg-3">
                    <?= $form->field($model, 'idtruhong')->textInput(['maxlength' => true]) ?>
                </div>
                <div class="col-lg-3">
                    <?= $form->field($model, 'kichco')->textInput(['maxlength' => true]) ?>
                </div>
                <div class="col-lg-3">
                    <?= $form->field($model, 'kcmiengphu')->textInput(['maxlength' => true]) ?>
                </div>
                <div class="col-lg-3">
                    <?= $form->field($model, 'loaitruhon')->textInput(['maxlength' => true]) ?>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-3">
                ...
                <div class="col-lg-3">
                    <?= $form->field($model, 'dknuocvao')->textInput() ?>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-3">
                ...
                <div class="col-lg-3">
                    <?= $form->field($model, 'slmiengphu')->textInput() ?>
                </div>
                <div class="col-lg-3">
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <?= $form->field($model, 'donviquanl')->textInput() ?>
                </div>
                <div class="col-lg-3">
