...
/* @var $searchModel app\modules\quanly\models\capnuocgd\danhmuc\GdDmXulysucoSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = (isset($const['title'])) ? $const['title'] : 'Danh mục xử lý sự cố';
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="gd-dm-xulysuco-index">
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ...
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Thêm mới Danh mục xử lý sự cố','class'=>'btn btn-success'])
                ],
            ],          
            'striped' => true,
            'condensed' => true,
