...
<div class="gd-trambom-form">
    ...
    <div class="block block-themed">
        ...
        <div class="block-content">
            ...
            <div class="row">
                <div class="col-lg-3">
                    <?= $form->field($model, 'idtrambom')->textInput(['maxlength' => true]) ?>
                </div>
                <div class="col-lg-3">
                    <?= $form->field($model, 'loaitram')->textInput(['maxlength' => true]) ?>
                </div>
                <div class="col-lg-3">
                    <?= $form->field($model, 'tentram')->textInput(['maxlength' => true]) ?>
                </div>
                <div class="col-lg-3">
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <?= $form->field($model, 'congsuat')->textInput() ?>
                </div>
                <div class="col-lg-3">
                    <?= $form->field($model, 'soluongbom')->textInput() ?>
                </div>
                <div class="col-lg-3">
