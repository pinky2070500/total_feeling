...
/* @var $searchModel app\modules\quanly\models\capnuocgd\GdDataLoggerSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = (isset($const['title'])) ? $const['title'] : 'Data Logger';
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="gd-data-logger-index">
