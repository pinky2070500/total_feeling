...
<div class="gd-dongho-kh-gd-form">
    ...
    <div class="block block-themed">
        ...
        <div class="block-content">
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <?= $form->field($model, 'ngaybamchi')->widget(\kartik\widgets\DatePicker::className()) ?>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-3">
            ...
            <div class="row">
                <div class="col-lg-3">
                    <?= $form->field($model, 'ngaycapnha')->widget(\kartik\widgets\DatePicker::className()) ?>
                </div>
                <div class="col-lg-3">
