...
/* @var $model app\modules\quanly\models\aphu\OngNuoctho */
        ...
        <div class="block-content">
            ...
            <div class="row pb-2">
                <div class="col-lg-12">
                    ...
                    <?= Html::hiddenInput('OngNuoctho[geojson]', $model->geojson, ['id' => 'geojson']) ?>
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <?= $form->field($model, 'chieudai')->textInput(['maxlength' => true]) ?>
                </div>
            </div>
