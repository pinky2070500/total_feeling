...
/* @var $model app\modules\quanly\models\aphu\OngPhanphoi */
        ...
        <div class="block-content">
            ...
            <div class="row pb-2">
                <div class="col-lg-12">
                    ...
                    <?= Html::hiddenInput('OngPhanphoi[geojson]', $model->geojson, ['id' => 'geojson']) ?>
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <?= $form->field($model, 'danhdau')->textInput(['maxlength' => true]) ?>
                </div>
                <div class="col-lg-3">
