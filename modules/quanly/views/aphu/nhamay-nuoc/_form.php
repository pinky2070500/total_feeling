...
<div class="nhamay-nuoc-form">
    ...
    <div class="block block-themed">
        ...
        <div class="block-content">
            ...
            <div class="row">
                <div class="col-lg-3">
                    <?= $form->field($model, 'congnghexl')->textInput(['maxlength' => true]) ?>
                </div>
                <div class="col-lg-3">
                    <?= $form->field($model, 'namxd')->textInput(['maxlength' => true]) ?>
                </div>
                <div class="col-lg-3">
                    <?= $form->field($model, 'nguon')->textInput(['maxlength' => true]) ?>
                </div>
                <div class="col-lg-3">
                    <?= $form->field($model, 'congsuat_1')->textInput(['maxlength' => true]) ?>
                </div>
            </div>
