...
/* @var $searchModel app\modules\quanly\models\caphe\CayCaPheDaTrongSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = (isset($const['title'])) ? $const['title'] : 'Cây cà phê đã trồng';
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="cay-ca-phe-da-trong-index">
