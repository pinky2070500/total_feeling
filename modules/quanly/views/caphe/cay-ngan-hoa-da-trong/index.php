...
/* @var $searchModel app\modules\quanly\models\caphe\CayNganHoaDaTrongSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = (isset($const['title'])) ? $const['title'] : 'Cây ngân hoa đã trồng';
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="cay-ngan-hoa-da-trong-index">
