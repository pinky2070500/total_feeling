...
use app\modules\quanly\models\capnuocgd\GdDonghoKhGdSearch;
...
/**
 * GdDonghoKhGdController implements the CRUD actions for GdDonghoKhGd model.
 */
class GdDonghoKhGdController extends QuanlyBaseController
{
    ...
    {
        $searchModel = new GdDonghoKhGdSearch();
    ...
    /**
     * Displays a single GdDonghoKhGd model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Finds the GdDonghoKhGd model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return GdDonghoKhGd the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = GdDonghoKhGd::findOne($id)) !== null) {
            return $model;
        } else {
