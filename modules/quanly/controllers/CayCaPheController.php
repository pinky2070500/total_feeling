 ...
 */
class CayCaPheController extends Controller
{

    public $title = "CayCaPhe";
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Thêm mới CayCaPhe",
                    'content'=>'<span class="text-success">Thêm mới CayCaPhe thành công</span>',
                    'footer'=> Html::button('Đóng',['class'=>'btn btn-light float-right','data-bs-dismiss'=>"modal"]).
                            Html::a('Tiếp tục thêm mới',['create'],['class'=>'btn btn-primary float-left','role'=>'modal-remote'])
                ];
            }else{
                return [
                    'title'=> "Create new CayCaPhe",
                    'content'=>$this->renderAjax('create', [
                        'model' => $model,
                    ]),
                    'footer'=> Html::button('Đóng',['class'=>'btn btn-light float-right','data-bs-dismiss'=>"modal"]).
